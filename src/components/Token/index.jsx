...
export default function Token({data,index}) {
    ...
    let totalDate = ( DDAY.getTime()/1000 - data.Data.lockTimestamp )
    let dateLeft = (( DDAY.getTime() - new Date().getTime() ) / 1000)

    const percentLeft = ((dateLeft/totalDate)*100)
            ...
            <div className="token">
                ...
                <div className="wrapper">
                    ...
                    <div className="total-token">
                        {dollarUSLocale.format(data.Data.amount/Math.pow(10,8))} AZT
                    </div>
                </div>
